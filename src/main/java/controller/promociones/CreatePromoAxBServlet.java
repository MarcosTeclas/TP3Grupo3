...
@WebServlet("/crearPromoAxB.do")
public class CreatePromoAxBServlet extends HttpServlet {

	private static final long serialVersionUID = -5542240872085288419L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/view/promociones/crearPromoAxB.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		PromoAxB promocion = promocionService.createPromoAxB(nombre, tipoAtraccion, atraccionesIncluidas);
